...
import { HeadComponent as Head } from '../components/Head/HeadComponent'
...
export default function SnakeGame() {
  ...
  const [previousVelocity, setPreviousVelocity] = useState({ dx: 0, dy: 0 });
  ...
  return (
    <div className='snake-game'>
      <Head />
      <main className='snake-game-main'>
        <canvas
          ref={canvasRef}
          width={canvasWidth + 1}
        ...
        <section className='snake-game-section'>
          ...
          {!isLost && countDown > 0 ? (
            <button onClick={startGame} className='snake-game-button'>
